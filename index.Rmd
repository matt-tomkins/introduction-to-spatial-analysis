...
For course development and testing, the following formatting is for **problems to be fixed**:

<div class="problem"> 
This is a problem.
</div>

The following formatting is used for **tasks for Matt to complete**:

<div class="task"> 
This is a task.
</div>

The following formatting is used for **advice** or **key notes**:

<div class="note"> 
This is a note. 
</div>

The following formatting is used for **quotations**:
