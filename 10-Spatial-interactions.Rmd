...
which gives us access to Python functionality, all of the ArcGIS tools,
many of which you will be familiar with e.g.,
[`numpy`](https://numpy.org/). via
...
code blocks will switch from `[*]` to `[#]` to denote completion,
